            ...
            {backendOnline === false && (
              <div className="mb-6 p-4 rounded bg-[#fff8e1] border border-[#ffe082] text-[#896400] text-xs font-mono-code flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="font-bold text-[#6b4e00]">FastAPI Backend Offline</p>
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-white hover:bg-[#fff3c4] border border-[#ffe082] rounded text-xs font-bold flex items-center gap-1 transition-colors cursor-pointer text-gray-800"
                >
