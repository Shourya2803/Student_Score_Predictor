    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            ...
            className="px-3.5 py-1.5 text-xs font-mono-code font-bold uppercase tracking-wider text-white bg-[#0052cc] hover:bg-[#0040a2] rounded shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
        ...
        <button
          ...
          className="lg:hidden p-2 text-[#4e6072] hover:text-[#191c1e] focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-b border-[#e1e2e4] px-4 py-4 space-y-2 shadow-md">
          <div className="sm:hidden flex items-center gap-2 px-3 py-1.5 rounded bg-[#f3f4f6] border border-[#e1e2e4] text-xs font-mono-code mb-2">
            <span className="flex items-center gap-1.5 text-[#16a34a] font-semibold">
              <span className="w-2 h-2 rounded-full bg-[#16a34a]" />
              Frontend: Online
            </span>
