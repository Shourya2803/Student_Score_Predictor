...
console.log("Predicted Score:", data.predicted_score);`
  ...
  return (
    <section id="api-docs" className="py-16 bg-[#f8f9fb] border-b border-[#e1e2e4] text-[#191c1e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-2">
          ...
          <p className="text-xs sm:text-sm text-[#434654] font-normal">
            As documented in Stitch Screen 9abe1962: exact request/response schemas for integration.
          </p>
        </div>

        {/* API Code Snippets Inspector Card */}
        <div className="mb-10 p-6 bg-white rounded border border-[#e1e2e4] shadow-xs">
          <div className="flex items-center justify-between border-b border-[#e1e2e4] pb-3 mb-4">
            <div className="flex items-center gap-2 font-mono-code text-xs">
              <Terminal className="w-4 h-4 text-[#0052cc]" />
              <span className="font-bold text-[#191c1e]">POST /predict</span>
              <span className="text-[#16a34a] bg-[#dcfce7] px-2 py-0.5 rounded text-[10px] uppercase font-semibold">
                HTTP 200 OK
              </span>
            </div>
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-xs font-mono-code uppercase font-semibold cursor-pointer transition-colors ${
                    activeLang === lang
                      ...
                      : "bg-[#f3f4f6] text-[#4e6072] hover:bg-[#e1e2e4]"
                  }`}
                >
                  {lang}
                </button>
          ...
          <div className="relative">
            <pre className="p-4 bg-[#191c1e] text-[#f8f9fb] rounded font-mono-code text-xs overflow-x-auto border border-[#434654]">
              <code>{codeSnippets[activeLang]}</code>
            </pre>
            <button
              onClick={() => handleCopy(codeSnippets[activeLang], activeLang)}
              className="absolute top-3 right-3 p-1.5 bg-[#434654] hover:bg-[#737685] text-white rounded text-xs font-mono-code flex items-center gap-1 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="p-6 bg-white rounded border border-[#e1e2e4]">
            <div className="flex items-center gap-2 mb-4 pb-2 border-b border-[#e1e2e4]">
              <HelpCircle className="w-4 h-4 text-[#0052cc]" />
              <h3 className="text-sm font-mono-code font-bold text-[#191c1e] uppercase">Algorithm Description</h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs font-mono-code">
              <div className="p-2.5 bg-[#f8f9fb] rounded border border-[#e1e2e4]">
                <div className="text-[10px] text-[#737685] uppercase">Inputs</div>
                <div className="font-bold text-[#191c1e] mt-0.5">6 Features</div>
              </div>
              <div className="p-2.5 bg-[#f8f9fb] rounded border border-[#e1e2e4]">
                <div className="text-[10px] text-[#737685] uppercase">Output Target</div>
                <div className="font-bold text-[#0052cc] mt-0.5">predicted_score</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 bg-white rounded border border-[#e1e2e4]">
            <div className="flex items-center gap-2 mb-4 pb-2 border-b border-[#e1e2e4]">
              ...
              <h3 className="text-sm font-mono-code font-bold text-[#191c1e] uppercase">Evaluated Model Candidates</h3>
            </div>
                    ...
                    <span
                      className={`text-[9px] font-bold uppercase px-2 py-0.5 rounded ${
                        item.selected
                          ...
                          : "bg-[#e1e2e4] text-[#4e6072]"
                      }`}
                    >
                      {item.status}
                    </span>
                  </div>
                  <p className="text-[11px] text-[#434654]">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
